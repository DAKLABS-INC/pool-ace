              ...
              <div className="flex items-center gap-1">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent
                      side="right"
                      className="bg-black text-xs text-primary-glow border border-primary shadow-[0_0_15px_rgba(34,197,94,0.5)] rounded-md px-3 py-1"
                    >
                      ...
                      <span className="opacity-80">
                        to participate in pools and place bets.
                      </span>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
            ...
            <div className="flex items-start space-x-3 p-3 bg-muted/50 rounded-lg">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setUseDakDiscount(checked as boolean)
                }
              />
              <div className="grid gap-1.5 leading-none">
                ...
                <p className="text-xs text-muted-foreground">
                  Apply DAK tokens to get small discounts on transaction fees
